...
shinyUI(
  navbarPage("Shiny Application for Developing Data Product",
             tabPanel("Analysis",
                      fluidPage(
             ...
             tabPanel("Go back to my Github repository",
                      a("https://github.com/ziefairoose?tab=repositories"),
                      hr(),
                      h2("I hope you like the Shiny App"),
                      h2("The name of the repositories is Data_Products Project")
             )
  )
)
